...
public class FlowRule extends AbstractRule {
    ...
    /**
     * Rule定义的行为应该只是Sentinel在最初搭建框架时定义的约定，Sentinel自己并没有完全遵守这个约定，由很多规则并没有将
     * passCheck方法交给Rule实现，而是交给了Checker实现，Checker是后续引入的，用于替代Rule的passCheck方法
